...
title(['未经修正前的video(红)与gyro(绿)轨迹,fps:',num2str(minD(1))]);
...
title(['修正后的轨迹：欧式距离最小时，GYRO的平移量:',num2str(minD(2)),'最小距离：',num2str(minD(3))]);
saveas(2,[dir,'\修正后的轨迹GYRO的平移量',num2str(minD(2)),'.fig']);
%close(2);
end
